...
public class UI {
    ...
    public static void printMatch(ChessMatch chessMatch, List<ChessPiece> capturedPieces){
        ...
        if (chessMatch.getCheck()){
            System.out.println(ANSI_RED + "Check on " + chessMatch.getCurrentPlayer() + "!" + ANSI_RESET);
        }
    }
